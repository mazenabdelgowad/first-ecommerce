...
const Product = ({
	...
	return (
		<NavLink
			target="_blank"
			className="product rounded-4 bg-white shadow-lg p-3"
			to={`/products/${productIdApi}`}
			data-aos={dataAos}
		>
			<img
				alt={altText}
			...
			/>
			<h5 className="brand-name fw-bold text-black-50 text-capitalize mt-2">
				{brandName}
			</h5>
			<h5 className="product-title text-dark text-capitalize my-3">
				{productTitle}
			</h5>
			<div className="rate d-flex gap-1 my-3">{numberOfStars()}</div>
